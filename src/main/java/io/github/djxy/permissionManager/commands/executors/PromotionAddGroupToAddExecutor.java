...
public class PromotionAddGroupToAddExecutor extends CommandExecutor {
    ...
    public void execute(CommandSource source, Map<String, Object> values) throws CommandException {
        ...
        source.sendMessage(Main.getTranslatorInstance().translate(source, "promotionAddGroupToAdd", CoreUtil.createMap("group", group.getIdentifier(), "promotion", promotion.getName())));
    }
}
