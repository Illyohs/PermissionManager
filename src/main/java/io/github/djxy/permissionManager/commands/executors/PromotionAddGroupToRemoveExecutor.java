...
public class PromotionAddGroupToRemoveExecutor extends CommandExecutor {
    ...
    public void execute(CommandSource source, Map<String, Object> values) throws CommandException {
        ...
        source.sendMessage(PREFIX.concat(Text.of("You added the group ", INFO_COLOR, group.getIdentifier(), RESET_COLOR, " to remove to the promotion ", INFO_COLOR, promotion.getName(), RESET_COLOR, ".")));
